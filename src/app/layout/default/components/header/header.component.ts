...
export class DefaultLayoutHeaderComponent implements OnInit, OnDestroy {
  ...
  constructor(public pro: DefaultLayoutService, @Inject(DOCUMENT) private doc: any, private cdr: ChangeDetectorRef) { }

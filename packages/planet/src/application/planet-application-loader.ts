                        ...
                        switchMap(shouldLoadApps => {
                            const loadApps$ = shouldLoadApps.map(app => {
                                ...
                                if (
                                    ...
                                    console.log('switchMap->runOutsideAngular');

                                    return this.ngZone.runOutsideAngular(() => {
                                        return this.startLoadAppAssets(app);
                                    });
                                } else {
                                    console.log('switchMap->of');

                                    return of(app);
                                }
                            });
                            console.log('switchMap->loadApps');
                            ...
                            apps.forEach(app => {
                                ...
                                if (appStatus === ApplicationStatus.bootstrapped) {
                                    ...
                                    apps$.push(
                                        of(app).pipe(
                                            tap(() => {
                                                console.log('Bootstrap->navigateByUrl');
                                                this.showApp(app);
                                    ...
                                    apps$.push(
                                        of(app).pipe(
                                            switchMap(() => {
                                                console.log('Bootstrap->assetsLoaded->navigateByUrl');
                                    ...
                                    apps$.push(
                                        of(app).pipe(
                                            tap(() => {
                                                console.log('Bootstrap->active->navigateByUrl');
